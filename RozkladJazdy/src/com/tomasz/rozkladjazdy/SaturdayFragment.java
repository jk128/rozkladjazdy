...
public class SaturdayFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      // title column/row
         ...
         TableRow godz0 = new TableRow(getActivity());  TableRow godz1 = new TableRow(getActivity());TableRow godz2 = new TableRow(getActivity()); TableRow godz3 = new TableRow(getActivity());  TableRow godz4 = new TableRow(getActivity());TableRow godz5 = new TableRow(getActivity());
		 TableRow godz6 = new TableRow(getActivity());  TableRow godz7 = new TableRow(getActivity());TableRow godz8 = new TableRow(getActivity()); TableRow godz9 = new TableRow(getActivity());  TableRow godz10 = new TableRow(getActivity());TableRow godz11 = new TableRow(getActivity());
		 TableRow godz12 = new TableRow(getActivity());  TableRow godz13 = new TableRow(getActivity());TableRow godz14 = new TableRow(getActivity()); TableRow godz15 = new TableRow(getActivity());  TableRow godz16 = new TableRow(getActivity());TableRow godz17 = new TableRow(getActivity());
		 TableRow godz18 = new TableRow(getActivity());  TableRow godz19 = new TableRow(getActivity());TableRow godz20 = new TableRow(getActivity()); TableRow godz21 = new TableRow(getActivity());  TableRow godz22 = new TableRow(getActivity());TableRow godz23 = new TableRow(getActivity());
		 TableRow legenda= new TableRow(getActivity());
		
		 desc.setText(description[0]);
		 legenda.addView(desc, params);
		int godz_0=0; int godz_1=0;int godz_2=0;int godz_3=0;int godz_4=0;int godz_5=0;int godz_6=0;int godz_7=0;int godz_8=0;int godz_9=0;int godz_10=0;int godz_11=0;int godz_12=0;int godz_13=0;int godz_14=0;int godz_15=0;int godz_16=0;int godz_17=0;int godz_18=0;int godz_19=0;int godz_20=0;int godz_21=0;int godz_22=0;int godz_23=0;
		 do {
			tmp.append(" ");
			tmp.append(mCursor.getString(0));
...
if(mCursor.getString(0).substring(0,3).equals("23:"))
{
    ...
    godz23.addView(tV_txt1);
        ...
        tablelayout1.addView(godz0); tablelayout1.addView(godz1);  tablelayout1.addView(godz2); tablelayout1.addView(godz3);  tablelayout1.addView(godz4); tablelayout1.addView(godz5);  tablelayout1.addView(godz6); tablelayout1.addView(godz7); 
        tablelayout1.addView(godz8); tablelayout1.addView(godz9);  tablelayout1.addView(godz10); tablelayout1.addView(godz11);  tablelayout1.addView(godz12); tablelayout1.addView(godz13);  tablelayout1.addView(godz14); tablelayout1.addView(godz15);
        tablelayout1.addView(godz16); tablelayout1.addView(godz17);tablelayout1.addView(godz18);  tablelayout1.addView(godz19); tablelayout1.addView(godz20);  tablelayout1.addView(godz21); tablelayout1.addView(godz22);
        tablelayout1.addView(godz23);  tablelayout1.addView(legenda);
         //
